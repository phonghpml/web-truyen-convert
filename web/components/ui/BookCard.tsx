      ...
      <div className="flex gap-3">
        <button
          ...
          className={`${savedHistory ? "bg-orange-500 text-black" : "bg-white text-black"
            } text-[9px] px-6 py-3 rounded-full font-black hover:scale-105 transition-all shadow-lg uppercase flex flex-col items-center min-w-[120px]`}
        >
          {savedHistory ? (
            <>
              <span>Tiếp tục {">"}</span>
              <span className="text-[7px] opacity-70 truncate max-w-[80px] lowercase">
